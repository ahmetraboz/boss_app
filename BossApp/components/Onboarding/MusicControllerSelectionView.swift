...
struct MusicControllerSelectionView: View {
    ...
    @State private var selectedMediaController: MediaControllerType = BossConfig[.mediaController]
        ...
        HStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                if controller == .youtubeMusic {
                    Text("Requires the Boss App desktop bridge.")
                        .font(.subheadline)
                        .foregroundColor(.secondary)
                        .padding(.top, 2)
                }
...
extension MediaControllerType {
    var description: String {
        ...
        case .youtubeMusic:
            return "Requires the Boss App desktop bridge."
        }
    }
}

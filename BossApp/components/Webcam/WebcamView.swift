            ...
            ZStack {
                if let previewLayer = webcamManager.previewLayer {
                    CameraPreviewLayerView(previewLayer: previewLayer)
                        .scaleEffect(x: -1, y: 1)
                        .clipShape(RoundedRectangle(cornerRadius: BossConfig[.mirrorShape] == .rectangle ? MusicPlayerImageSizes.cornerRadiusInset.opened : 100))
                ...
                if !webcamManager.isSessionRunning {
                    ZStack {
                        RoundedRectangle(cornerRadius: BossConfig[.mirrorShape] == .rectangle ? 12 : 100)

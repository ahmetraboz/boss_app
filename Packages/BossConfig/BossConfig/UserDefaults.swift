...
extension UserDefaults {
	func _get<Value: BossConfig.Serializable>(_ key: String) -> Value? {
	...
	func _set<Value: BossConfig.Serializable>(_ key: String, to value: Value) {
		if (value as? (any _BossConfigOptionalProtocol))?._defaults_isNil == true {
	...
	public subscript<Value: BossConfig.Serializable>(key: BossConfig.Key<Value>) -> Value {
